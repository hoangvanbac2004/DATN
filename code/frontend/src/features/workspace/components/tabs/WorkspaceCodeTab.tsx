...
import { Code2, GitBranch, GitCommit, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 text-text-primary pb-12">
      <div className="flex items-center justify-between border-b border-surface-border pb-4">
        <div>
          <h2 className="text-lg font-bold font-heading text-text-primary">Source Code & Repositories</h2>
          <p className="text-xs text-text-secondary">Connect GitHub, GitLab, or Bitbucket repositories to track code commits and pull requests.</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-surface-border bg-surface p-6 shadow-xs flex flex-col items-center justify-center text-center space-y-4 max-w-lg mx-auto my-8">
        ...
        <div>
          <h3 className="text-sm font-bold text-text-primary font-heading">Connect your repository</h3>
          <p className="mt-1 text-xs text-text-muted">Automatically link commits, branches, and pull requests to work items in this space.</p>
        </div>
        <button
